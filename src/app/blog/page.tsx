...
export default function BlogPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'Blog IPTV France - Guides & Actualités IPTV SMARTERS PRO';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Découvrez nos guides complets, tutoriels et actualités IPTV. Optimisez votre abonnement IPTV SMARTERS PRO avec nos conseils d\'experts. Blog IPTV France mis à jour régulièrement.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Découvrez nos guides complets, tutoriels et actualités IPTV. Optimisez votre abonnement IPTV SMARTERS PRO avec nos conseils d\'experts. Blog IPTV France mis à jour régulièrement.';
